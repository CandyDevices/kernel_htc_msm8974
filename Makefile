...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -O3 -Wno-array-bounds -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -Wno-array-bounds -fomit-frame-pointer  -fgcse-las -fgraphite -floop-flatten -floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block -pipe -Wno-unused-parameter -Wno-sign-compare -Wno-missing-field-initializers -Wno-unused-variable -Wno-unused-value
HOSTCXXFLAGS = -O3 -Wno-array-bounds -fgcse-las -fgraphite -floop-flatten -floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block -pipe -floop-nest-optimize
...
KBUILD_CFLAGS	+= -O3 -Wno-array-bounds
endif
